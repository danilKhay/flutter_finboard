...
QUARTER_COLUMNS = [
    ...
    "currentratio",
    "netinccmn", ]
URL = 'https://github.com/danilKhay/flutter_finboard/releases/tag/weights/fair_marketcap.pickle'
COMMODITIES_CODES = [
    'LBMA/GOLD',
    'JOHNMATT/PALL', ]
...
def FairMarketcap(pretrained=True) -> Pipeline:
...
def main():
    ...
    '''
    pipeline = FairMarketcap(pretrained=False)
