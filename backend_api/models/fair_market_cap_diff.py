...
URL = 'https://github.com/danilKhay/flutter_finboard/releases/tag/weights/fair_marketcap_diff.pickle'
COMMODITIES_CODES = [
    'LBMA/GOLD',
    'JOHNMATT/PALL',
]
...
def FairMarketcapDiff(pretrained=True) -> Pipeline:
...
def main():
    ...
    '''
    pipeline = FairMarketcapDiff(pretrained=False)
