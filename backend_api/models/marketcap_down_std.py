...
URL = 'https://github.com/danilKhay/flutter_finboard/releases/tag/weights/marketcap_down_std.pickle'
...
def MarketcapDownStd(pretrained=True) -> Pipeline:
...
def main():
    ...
    '''
    pipeline = MarketcapDownStd(pretrained=False)
